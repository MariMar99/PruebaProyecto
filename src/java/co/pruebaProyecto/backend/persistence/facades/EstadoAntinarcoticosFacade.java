...
import co.pruebaProyecto.backend.persistence.entity.EstadoAntinarcoticos;
 ...
 */
@Stateless
public class EstadoAntinarcoticosFacade extends AbstractFacade<EstadoAntinarcoticos> {
